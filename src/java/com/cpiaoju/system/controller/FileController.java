...
/**
 * 文件服务器
 * Created by huhb on 2018-12-24 下午 4:10.
 */
@CrossOrigin
@Controller
@RequestMapping("/file")
public class FileController {
    ...
    @ResponseBody
    @PostMapping("/upload")
    public com.cpiaoju.common.JsonResult upload(@RequestParam MultipartFile file) {
        // 文件原始名称
        ...
        try {
            ...
            return com.cpiaoju.common.JsonResult.ok("上传成功").put("url", path);
        } catch (Exception e) {
            e.printStackTrace();
            return com.cpiaoju.common.JsonResult.error("上传失败").put("error", e.getMessage());
        }
    }
