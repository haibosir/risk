 ...
 * @since 2021-01-04
 */
@TableName("sys_invoice_warning_contract")
public class InvoiceWarningContract implements Serializable {
    ...
    @TableField(exist = false)
    private List<InvoiceWarningInvoice> invoiceList;
    ...
    public List<InvoiceWarningInvoice> getInvoiceList() {
        return invoiceList;
    }

    public void setInvoiceList(List<InvoiceWarningInvoice> invoiceList) {
